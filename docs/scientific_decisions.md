...
| 2026-09-23 | Parameterize neutral BNZ using GAFF2 and AM1-BCC | BNZ is neutral benzene; the workflow produced symmetric `ca`/`ha` types and charges, total charge 0, complete parameters, and a warning-free TLeap topology | Selected | Paired with ff19SB and OPC; combined-topology validation remains required |
| 2026-09-23 | Use ff19SB for protein, GAFF2/AM1-BCC for BNZ, and OPC water | ff19SB is intended for use with modern explicit-solvent models, and GAFF2 belongs to the Amber force-field family | Selected | Combined topology generation and GROMACS validation remain required |
| 2026-09-23 | Assign protonation states at pH 7.5 and model HIS31 as HID | PROPKA 3.5.1 predicted HIS31 pKa 7.34; ND1 is 2.728 Å from ASP70 OD2, supporting an ND1-H hydrogen bond | Selected | HIS31 is near its predicted pKa, so its fixed neutral state is a modeling approximation |