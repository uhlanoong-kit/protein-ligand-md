...
| 2026-09-23 | Parameterize neutral BNZ using GAFF2 and AM1-BCC | BNZ is neutral benzene; the workflow produced symmetric `ca`/`ha` types and charges, total charge 0, complete parameters, and a warning-free TLeap topology | Selected | Requires selection of a compatible AMBER protein force field and water model |
